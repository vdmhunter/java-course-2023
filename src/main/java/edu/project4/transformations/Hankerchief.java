...
/**
 * The {@code Hankerchief} class represents a transformation that applies a "Hankerchief" effect to a 2D point.
...
public class Hankerchief implements Transformation {
    /**
     * Applies the "Hankerchief" transformation to the given 2D point.
     *
     * @param point The input point to be transformed.
     * @return The transformed point after applying the "Hankerchief" effect.
